      ...
      <div className={`bg-[#0D2E78] text-white text-[11px] sm:text-xs font-medium transition-all duration-300 overflow-hidden ${scrolled ? 'h-0 opacity-0' : 'h-10 opacity-100'}`}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {(settings?.socialLinks?.facebook || settings?.socialLinks?.twitter || settings?.socialLinks?.instagram || settings?.socialLinks?.youtube || settings?.socialLinks?.tiktok) && (
              <div className="flex items-center gap-3 border-l border-white/20 pl-6 hidden sm:flex">
                {settings?.socialLinks?.facebook && (
                  <a href={settings.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
                ...
                {settings?.socialLinks?.twitter && (
                  <a href={settings.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
                ...
                {settings?.socialLinks?.instagram && (
                  <a href={settings.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
                ...
                {settings?.socialLinks?.youtube && (
                  <a href={settings.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
                ...
                {settings?.socialLinks?.tiktok && (
                  <a href={settings.socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
                    <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005.8 15.7a6.33 6.33 0 0010.86-4.43V7.53a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1.84 1.04z"/></svg>
                  </a>
                )}
              </div>
            )}
