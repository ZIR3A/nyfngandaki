...
export default function ConnectError({ locale = 'en', onRetry }) {
  const isNp = locale === 'np';
  const message = isNp ? 'à¤®à¤¾à¤« à¤—à¤°à¥à¤¨à¥à¤¹à¥‹à¤²à¤¾, à¤¨à¥‡à¤¤à¥ƒà¤¤à¥à¤µà¤•à¥‹ à¤¸à¤¨à¥à¤¦à¥‡à¤¶ à¤²à¥‹à¤¡ à¤—à¤°à¥à¤¨ à¤¸à¤•à¤¿à¤à¤¨ à¥¤' : 'Sorry, the leadership message could not be loaded.';
