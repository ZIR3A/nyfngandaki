...
export default function WhatWeDoError({ locale = 'en', onRetry }) {
  ...
  const message = isNp ? 'à¤®à¤¾à¤« à¤—à¤°à¥à¤¨à¥à¤¹à¥‹à¤²à¤¾, à¤¹à¤¾à¤®à¥à¤°à¤¾ à¤•à¤¾à¤°à¥à¤¯à¤•à¥à¤°à¤®à¤¹à¤°à¥‚à¤•à¥‹ à¤µà¤¿à¤µà¤°à¤£ à¤²à¥‹à¤¡ à¤—à¤°à¥à¤¨ à¤¸à¤•à¤¿à¤à¤¨ à¥¤' : 'Sorry, the programs and activities could not be loaded.';
