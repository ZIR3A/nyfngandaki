            ...
            <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
              {activities.length === 0 ? (
                ...
                activities.map((activity) => (
                  <tr key={activity._id.toString()} className="hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {activity.featured ? (
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-400">
                          Featured
                        </span>
                      ) : "-"}
                    </td>
