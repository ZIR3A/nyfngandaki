        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody className="divide-y divide-gray-100">
              {committees.length === 0 ? (
                <tr>
                  <td colSpan="6" className="px-6 py-12 text-center text-gray-500">No committees found.</td>
                </tr>
              ) : (
                committees.map((item) => (
                  <tr key={item._id.toString()} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-600 font-mono">{item.displayOrder || 0}</td>
